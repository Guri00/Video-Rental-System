...
namespace Video_Store
{
    class Rented
    {
        ...
        SqlConnection Conn_Rented = new SqlConnection(@"Data Source=LAPTOP-RAKIOMBV\SQLEXPRESS;Initial Catalog=RENT;Integrated Security=True");
        ...
        {// this mehod is used to find the top Custometr
            ...
            try
            {
                ...
                MessageBox.Show(FirstName + " (CustID " + Top + " ) is the Customer Rented Most Movies With " + Max + " times");
            }
            catch (Exception exception)
            {
                MessageBox.Show("Database Exception " + exception.Message);
