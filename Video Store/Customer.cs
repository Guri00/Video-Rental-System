...
namespace Video_Store
{
    ...
    {         //this code will be used in all methods to access the sql connection
        ...
        SqlConnection Conn_customer = new SqlConnection(@"Data Source=LAPTOP-RAKIOMBV\SQLEXPRESS;Initial Catalog=RENT;Integrated Security=True");
        ...
        {//this method is used to delete customer
            try
            {
                ...
                String Strr = "";
                Strr = "select Count(*) from RentedMovies where CustIDFK= @CustID and Rented ='1' ";
